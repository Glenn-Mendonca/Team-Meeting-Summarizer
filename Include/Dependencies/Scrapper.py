...
class Scrapper():
    ...
    def extractcaptions(self, senddata):
        ...
        try:
            div = self.driver.execute_script('var div = document.querySelector("#ow3 > div.T4LgNb > div > div:nth-child(9) > div.crqnQb > div.a4cQT > div:nth-child(1)");if (div.parentNode.hasChildNodes()) {html = div.innerHTML;div.parentNode.removeChild(div); return html;} else return "NULL";')
            if(div == "NULL"):
                raise NoSuchElementException
